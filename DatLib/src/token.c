...
const struct datlib_token datlib_tokens[] =
{
	...
	{TOKEN_ROMCENTER_FORCEDROMMODE, "TOKEN_ROMCENTER_FORCEDROMMODE"},
	{TOKEN_ROMCENTER_FORCEDBIOSMODE, "TOKEN_ROMCENTER_FORCEDBIOSMODE"},
	{TOKEN_ROMCENTER_FORCEDSAMPLEMODE, "TOKEN_ROMCENTER_FORCEDSAMPLEMODE"},
